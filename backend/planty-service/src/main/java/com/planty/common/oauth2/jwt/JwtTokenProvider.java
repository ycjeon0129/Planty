//package com.planty.common.oauth2.jwt;
//
//import com.planty.api.user.model.response.UserTokenResponse;
//import com.planty.config.ExpireTime;
...
//    public JwtTokenProvider(@Value("${spring.security.secretKey}") String secretKey) {
//        byte[] keyBytes = Decoders.BASE64.decode(secretKey);
//        this.key = Keys.hmacShaKeyFor(keyBytes);
//    }
//
//    //Authentication 을 가지고 AccessToken, RefreshToken 을 생성하는 메서드
//    public UserTokenResponse.TokenInfo generateToken(Authentication authentication) {
//        return generateToken(authentication.getName(), authentication.getAuthorities());
//    }
//
//    //name, authorities 를 가지고 AccessToken, RefreshToken 을 생성하는 메서드
//    public UserTokenResponse.TokenInfo generateToken(String name, Collection<? extends GrantedAuthority> inputAuthorities) {
//        //권한 가져오기
...
//                .compact();
//
//        return UserTokenResponse.TokenInfo.builder()
